public class Constants {
    ...
    public static final ArrayList<String> nixDeployments = ["ns", "router", "swarm", "web", "nginx", "webmail", "jenkins"]
    public static final ArrayList<String> developmentNixMachines = ["nginx3", "jenkins2", "mx1", "web98"]
